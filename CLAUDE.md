...
- **`LevelProgressCard`** sits under the assets card on the dashboard: level, a bar to the next level, the streak, and what the last points were for (the plan's "always show *why* XP was earned" guardrail, standing in for an XP ledger that phase 1 doesn't have).
